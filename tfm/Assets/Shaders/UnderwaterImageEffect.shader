Shader "PeerPlay/UnderwaterImageEffect"
{
    Properties
    {
		...
		_NoiseFreq("Noise Frecuency", float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			sampler2D _LastCameraDepthTexture, _CameraMotionVectorsTexture;
			uniform float _NoiseFreq, _NoiseScale, _NoiseSpeed, _PixelOffset;
